...
//TODO: Step 23 - Use the storyNumber property inside getStory(), getChoice1() and getChoice2() so that it gets the updated story and choices rather than always just the first (0th) one.
  ...
  void storyUpdateCounterNumber(){
    if(storyCountNumber < 3){
      storyCountNumber++;
    }else{
      if(storyCountNumber < _storyData.length-1){
        storyCountNumber++;
        getStory();
        getChoice1();
        getChoice2();
...
String getStory(){
  return _storyData[storyCountNumber].storyTitle;
}

//TODO: Step 11 - Create a method called getChoice1() that returns the text for the first choice1 from _storyData.
  String getChoice1(){
    return _storyData[storyCountNumber].choice1;
  }
//TODO: Step 12 - Create a method called getChoice2() that returns the text for the first choice2 from _storyData.
  String getChoice2(){
    return _storyData[storyCountNumber].choice2;
  }
